...
int main()
{
	...
	CSWoman * woman2{ new CSWoman("Susan Kare", 1954, "She is the designer of many typefaces, icons, and original marketing material for the original Macintosh OS\n") };
	...
	CSWoman * woman5{ new CSWoman("Beatrice Worsley", 1921, "In 2014, she was posthumously awarded the Lifetime Achievement Award in Computer Science\n") };
