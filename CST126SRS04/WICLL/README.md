...
Unresolved Issues:  incomplete, does not meet specifications, does not run, does not delete

Notes:  recieved information from www.codementor.io and submitted asignments on github
