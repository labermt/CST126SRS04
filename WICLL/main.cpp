...
int main()
{
	...
	cs_women.add(w4);
	const auto w5 = new CSWoman("Vera Molnar", 1924, "in 1968 she began working with computers, where she began to create algorithmic drawings based on simple geometric shapes geometrical themes.");
	cs_women.add(w5);
	const auto w6 = new CSWoman("Margaret Hamilton", 1936, "she was the Director of the Software Engineering Division of the MIT Instrumentation Laboratory, which developed on-board flight software for the Apollo space program.");
	cs_women.add(w6);
	const auto w7 = new CSWoman("Shafi Goldwasser", 1958, "she was a theoretical computer scientist, is a two-time recipient of the Gödel Prize for research on complexity theory.");
	cs_women.add(w7);
	const auto w8 = new CSWoman("Sandra Kurtzig", 1947, "founded ASK Computer Systems, an early Silicon Valley startup.");
	cs_women.add(w8);
	const auto w9 = new CSWoman("Sister Mary Kenneth Keller", 1913, "she became the first American woman to earn a Ph.D. in Computer Science in 1965.");
	cs_women.add(w9);
